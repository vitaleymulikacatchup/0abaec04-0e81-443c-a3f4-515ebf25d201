...
export const metadata: Metadata = {
  title: "Kavove - Premium Ukrainian Specialty Coffee",
  description: "Discover authentic Ukrainian specialty coffee. Local roasted beans, expert baristas, and cozy atmosphere in the heart of Kyiv.",
  keywords: "Ukrainian coffee, specialty coffee, local coffeeshop, Kyiv cafe, artisan espresso",
  metadataBase: new URL("https://kavove.local"),
  alternates: {
    canonical: "https://kavove.local"
  },
  openGraph: {
    title: "Kavove - Premium Ukrainian Specialty Coffee",
    description: "Experience authentic specialty coffee crafted with passion. Local roasted beans from Ukraine.",
    url: "https://kavove.local",
    siteName: "Kavove",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764175299027-iwmnk7v5.jpg",
      alt: "Premium Ukrainian coffeeshop Kavove"
    }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Kavove - Premium Ukrainian Coffee",
    description: "Local roasted specialty coffee in Kyiv",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764175299027-iwmnk7v5.jpg"]
  },
  robots: {
    index: true,
    follow: true
